# MODEL1310110056: MODEL1310110056
...
`pip install git+https://github.com/biomodels/MODEL1310110056.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110056.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110056 as model`
...
The model of heart muscle myocytes metabolism is derived from the community-
...
and identified by:
[MODEL1310110056](http://identifiers.org/biomodels.db/MODEL1310110056) .
